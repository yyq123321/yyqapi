...
import com.api.backend.common.*;
import com.api.backend.constant.CommonConstant;
import com.api.backend.exception.BusinessException;
import com.api.backend.model.dto.productinfo.ProductInfoAddRequest;
import com.api.backend.model.dto.productinfo.ProductInfoQueryRequest;
import com.api.backend.model.dto.productinfo.ProductInfoSearchTextRequest;
import com.api.backend.model.dto.productinfo.ProductInfoUpdateRequest;
import com.api.backend.model.enums.ProductInfoStatusEnum;
...
import static com.api.backend.constant.UserConstant.ADMIN_ROLE;
...
public class ProductInfoController {
    ...
    public BaseResponse<Page<ProductInfo>> listProductInfoByPage(ProductInfoQueryRequest productInfoQueryRequest, HttpServletRequest request) {
        ...
        Long addCoins = productInfoQueryRequest.getAddCoins();
        ...
        queryWrapper.like(StringUtils.isNotBlank(name), "name", name)
                ...
                .eq(ObjectUtils.isNotEmpty(addCoins), "addCoins", addCoins)
